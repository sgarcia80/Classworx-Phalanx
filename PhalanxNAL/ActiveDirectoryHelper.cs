...
namespace PhalanxNAL
{
    public class ActiveDirectoryHelper
    {
        ...
        private const string NOMBRE_PROPIEDAD_USERPRINCIPALNAME_AD = "userPrincipalName";
        ...
        public static string BuscarEmailExternoPorUsername(string username)
        {
            ...
            return BuscarLDAPEntryPropiedad(ConfigurationManager.AppSettings["LDAPBuscarNombreFilter"].Replace("[username]", username), NOMBRE_PROPIEDAD_USERPRINCIPALNAME_AD);
        }
