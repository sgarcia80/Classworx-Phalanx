...
namespace PhalanxDAL.Factories
{
    ...
    public class WinDomainsFactory
    {
        ...
        private bool? _filactive = false;

        public bool? FilActive
        {
        ...
        public WinDomainEntityCollection GetAll()
        {
            ...
            try
            {
                using (ISession session = DBMgr.factory.OpenSession())
                {
                    ...
                    if (_filactive.HasValue)
                    {
                        DataSearch = DataSearch.Add(Expression.Eq("Active", _filactive));
                    }
                    else
                    {
                        DataSearch = DataSearch.Add(Expression.Eq("Active", true));
                    }
