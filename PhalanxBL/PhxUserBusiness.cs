...
namespace PhalanxBL
{
    public class PhxUserBusiness
    {
        ...
        private const string LOGS_VISUAL_R = "@LOGS_VISUAL_R@";
        ...
        private const string BLANQUEO_RED_R = "@BLANQUEO_RED_R@";
        ...
        public bool ChkAccAdminApp(PhxUserEntity PhxUser)
        {
            string[] PrivilegiosAccesoAppAdmin = new string[] { CONF_MAILS_RW, CONF_MAILS_R, CONF_EDIFICIOS_RW
                ...
                , BLANQUEO_APP_RW, BLANQUEO_RED_RW, BLANQUEO_RED_R, BLANQUEO_TARJ_RW
            };
            return this.UsrHasAnyPrivilege(PhxUser, PrivilegiosAccesoAppAdmin);
            // return this.CheckRole(PhxUser, ADMIN_ACCESS);
        }
        public bool ChkAccParametria(PhxUserEntity PhxUser)
        {
            string[] PrivilegiosAccesoAppAdmin = new string[] {
                CONF_MAILS_RW, CONF_MAILS_R,
                ACTIVACION_ESQUEMA,
                CONF_EDIFICIOS_RW, CONF_EDIFICIOS_R,
                CONF_SUPERV_RW, CONF_SUPERV_R,
                ADM_DOMINIOS_RW, ADM_DOMINIOS_R,
                CONF_APP_BPM_RW, CONF_APP_BPM_R,
                CONF_SUBSI_RW, CONF_SUBSI_R,
                CONF_MACROS_RW, CONF_MACROS_R,
        ...
        public bool ChkAccContrasenas(PhxUserEntity PhxUser)
        {
            string[] PrivilegiosAccesoAppAdmin = new string[] {
                PWD_APP_RW, PWD_APP_R,
                PWD_AS400_RW, PWD_AS400_R,
        ...
        public bool ChkAccNotifClaves(PhxUserEntity PhxUser)
        {
            string[] PrivilegiosAccesoAppAdmin = new string[] {
                BLANQUEO_APP_RW, BLANQUEO_RED_RW, BLANQUEO_RED_R,
                BLANQUEO_TARJ_RW
            };
            return this.UsrHasAnyPrivilege(PhxUser, PrivilegiosAccesoAppAdmin);
        }
        public bool ChkAccAdministracion(PhxUserEntity PhxUser)
        {
            string[] PrivilegiosAccesoAppAdmin = new string[] { 
                ADM_APP_RW, ADM_APP_R,
                ADM_EQ_WIN_RW, ADM_EQ_WIN_R,
                ADM_EQ_UNIX_RW, ADM_EQ_UNIX_R,
                ADM_EQ_AS400_RW, ADM_EQ_AS400_R,
                ADM_BD_RW, ADM_BD_R,
                ADM_EQ_COM_RW, ADM_EQ_COM_R,
                ADM_GRP_SEG_SOLIC_R, ADM_GRP_SEG_SOLIC_RW,
                ADM_USR_RW, ADM_USR_R,
                ADM_GRP_SOLIC_RW, ADM_GRP_SOLIC_R,
                ADM_PERFILES_R, ADM_PERFILES_RW
            };
            return this.UsrHasAnyPrivilege(PhxUser, PrivilegiosAccesoAppAdmin);
        }
        public bool ChkAccReportes(PhxUserEntity PhxUser)
        {
            string[] PrivilegiosAccesoAppAdmin = new string[] {
                RPT_PLAN_CTRL_CLAVES,
                RPT_INVENT_CLAVES,
                RPT_ABM_USR,
                RPT_ASIG_PERF,
                RPT_LIST_USR_PWD,
                ...
                RPT_ABM_PERF,
                RPT_ASIG_PERM,
                RPT_LIST_PERFILES_PWD,
                RPT_LIST_TICKETS_PWD,
                RPT_TICKETS_RED_REC_EXT,
                RPT_AUTO_COBIS,
                RPT_EMP_META4,
                RPT_NOTIF_ALT_PEND,
                CONF_VIEW_PASSWORD
        ...
        public bool ChkAccAuditorias(PhxUserEntity PhxUser)
        {
            string[] PrivilegiosAccesoAppAdmin = new string[] {
                RPT_LOG_MODIF_PWD,
                RPT_MAILS,
        ...
        public bool AccVisualizacionPwdLogs(string usernamedomain)
        {
            string[] PrivilegiosAcceso = new string[] { LOGS_VISUAL_R };
            return this.UsrHasAnyPrivilege(usernamedomain, PrivilegiosAcceso);
        }
        ...
        public bool AccParamConfigWSCOBISRW(string usernamedomain)
        {
            string[] PrivilegiosAcceso = new string[] { CONF_WSCOBIS_RW };
            return this.UsrHasAnyPrivilege(usernamedomain, PrivilegiosAcceso);
        }
        ...
        {
            string[] PrivilegiosAcceso = new string[] { BLANQUEO_APP_RW, BLANQUEO_RED_RW, BLANQUEO_RED_R, BLANQUEO_TARJ_RW };
            return this.UsrHasAnyPrivilege(usernamedomain, PrivilegiosAcceso);
        }
        public bool AccBlanqueoAppRed(string usernamedomain)
        {
            string[] PrivilegiosAcceso = new string[] { BLANQUEO_APP_RW, BLANQUEO_RED_RW, BLANQUEO_RED_R };
            return this.UsrHasAnyPrivilege(usernamedomain, PrivilegiosAcceso);
        }
        ...
        {
            string[] PrivilegiosAcceso = new string[] { BLANQUEO_RED_RW, BLANQUEO_RED_R };
            return this.UsrHasAnyPrivilege(usernamedomain, PrivilegiosAcceso);
        }
        public bool AccBlanqueoRedWrite(string usernamedomain)
        {
