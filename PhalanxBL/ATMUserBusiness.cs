...
namespace PhalanxBL
{
    public class ATMUserBusiness
    {
        ...
        public int Save(ATMUserEntity AppUser, bool UpdatePassword, int GrupoSolicitudesID, FollowupRequestGroupEntityCollection GruposSeguimiento)
        {
            ...
            return this.Save(AppUser, UpdatePassword, GruposSolicitudes, GruposSeguimiento, true);
        }
        ...
        public int Save(ATMUserEntity AppUser, bool UpdatePassword, RequestGroupEntityCollection GruposSolicitudes, FollowupRequestGroupEntityCollection GruposSeguimiento, bool AvoidGrpInactive)
        {
            m_ATMUserFactory.SetAvoidInactiveGrps = AvoidGrpInactive;
            if (UpdatePassword)
            {
