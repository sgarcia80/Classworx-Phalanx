<%@ Page Language="C#" MasterPageFile="~/Principal.master" AutoEventWireup="true" CodeFile="closeexppwdrst.aspx.cs" Inherits="closeexppwdrst" Title="Phalanx Security Manager" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="text-align: center left">
        ...
        <table style="width: 100%; background-color: #f0f8ff;">
            <tr>
                <td align="center" style="width: 20%" valign="top" rowspan="5">
                    </td>
            ...
            <tr id="trBotGuardar" runat="server">
                ...
                <td align="left" colspan="2">
                    ...
                    <asp:Button ID="btnCancel" runat="server" CssClass="boton" Width="75px" Text="Cancelar"
                        ToolTip="Cierre de Contraseña" CausesValidation="False" PostBackUrl="~/Default.aspx">
                    </asp:Button></td>
            </tr>
        </table>    </div>
</asp:Content>
