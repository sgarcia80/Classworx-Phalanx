<%@ Page Language="C#" MasterPageFile="~/Principal.master" AutoEventWireup="true"
    CodeFile="closepwddetail.aspx.cs" Inherits="closepwddetail" Title="Phalanx Security Manager" %>
...
<asp:Content ID="ContentPwdDetail" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="text-align: left">
        ...
        <table id="Table3" width="100%" cellspacing="1" cellpadding="1" border="0">
            <tr style="height: 5px">
                <td colspan="2" style=" height: auto; background-color: #b0e0e6;">
                </td>
            </tr>
    ...
    <div style="text-align: center left">
        ...
        <table id="tblClosePwd" runat="server" cellspacing="1" cellpadding="1" border="0"
            ...
            <tr style="background-color: #b0e0e6; height: 5px">
                <td align="center" rowspan="1" colspan="2" valign="top">
                </td>
            </tr>
            <tr>
                <td align="center" rowspan="1" style="width: 20%; height: 21px;" valign="top">
            ...
            <tr id="trBotGuardar" runat="server">
                ...
                <td align="left" colspan="2">
                    ...
                    <asp:Button ID="btnCancel" runat="server" CssClass="boton" Width="75px" Text="Cancelar"
                        ToolTip="Cierre de Contraseña" CausesValidation="False" PostBackUrl="~/Default.aspx" UseSubmitBehavior="False">
                    </asp:Button></td>
            </tr>
        </table>
    </div>
