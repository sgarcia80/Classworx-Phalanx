<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="reqpwddetail.aspx.cs" Inherits="PhalanxWeb.reqpwddetail" %>
        ...
        <table id="Table3" width="100%" cellspacing="1" cellpadding="1" border="0">
            ...
            <tr style="background-color: #f0f8ff">
                <td style="width: 7px; height: 19px;">
                    <asp:Label ID="lblPwdType" runat="server" CssClass="tdTituloSub">Contraseña de Aplicativo</asp:Label>
                </td>
...
Si no visualiza la clave dentro de las 24 hs de haber sido solicitada, el presente pedido quedará sin efecto.</asp:TextBox></td>
            ...
            <tr id="trTblPwdInUse" runat="server" visible="false">
                <td align="center" colspan="1" style="width: 20%; vertical-align: top; background-color: #f0f8ff; text-align: center; height: 7px;"></td>
            ...
            <tr>
                <td style="height: 8px; width: 20%; vertical-align: top; background-color: #f0f8ff; text-align: center;"></td>
                <td style="height: 8px; width: 151px;"></td>
            </tr>
            <tr>
            ...
            <tr id="trBotGuardar" runat="server">
                ...
                <td align="left" colspan="2" valign="middle" style="height: 30">
                    ...
                    <asp:Button ID="btnCancel" runat="server" CssClass="boton" Width="75px" Text="Cancelar"
                        UseSubmitBehavior="false"
                        ToolTip="Solicitar Contraseña" CausesValidation="False" PostBackUrl="~/Default.aspx"></asp:Button>
                </td>
            </tr>
        </table>
    </div>
