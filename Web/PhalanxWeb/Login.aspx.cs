...
public partial class Login : System.Web.UI.Page
{
    ...
    protected void LoginButton_Click(object sender, EventArgs e)
    {
        ...
        {
            TraceHelper.Information("Se persisten las credenciales");
            ...
            TraceHelper.Information("Se redirecciona a la página de inicio");
        ...
        {
            TraceHelper.Information("Se visualiza mensaje de autenticacion fallida");
    ...
    private bool Autenticar(string dominio, string usuario, string password)
    {
        ...
        try
        {
            ...
            TraceHelper.Information("Se autentica el usario '{0}' contra el dominio '{1}'", usuario, dominio);
            ...
            TraceHelper.Information("Usuario autenticado correctamente", usuario, dominio);
        }
        catch (DirectoryServicesCOMException cex)
        {
            TraceHelper.Error(cex, "Error en autenticacion");
        ...
        {
            TraceHelper.Error(ex, "Error desconcido en autenticacion");
        }
