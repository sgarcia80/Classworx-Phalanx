<%@ Page Language="C#" MasterPageFile="~/Principal.master" AutoEventWireup="true" CodeBehind="DetalleTicketIp.aspx.cs" Inherits="NotifClavesWeb.DetalleTicketIp" Title="Macro SA - Notificación de Claves" %>
    ...
    <div style="text-align: center left">
        <table border="0" cellspacing="1" cellpadding="1" style="width: 100%; background-color: White">
            <tr id="row_Data_1" runat="server">
                <td id="colImage" align="center" rowspan="8" style="width: 20%; vertical-align: top; text-align: center;"
            ...
            <tr id="trMail" visible="false" runat="server">
                <td>
                    <asp:Label ID="Label3" runat="server" CssClass="LabelNormal">Mail</asp:Label></td>
                <td style="width: auto; height: auto;">
                    <asp:TextBox ID="txtEmail" runat="server" CssClass="labelCombo" ReadOnly="True"
            ...
            <tr>
                <td colspan="2">
                    <br />
                    <asp:Label ID="Label2" runat="server" style="color: Red" CssClass="LabelNormal">Importante: Tome nota de su nombre de usuario de red y contraseña para su uso. De perder esta información deberá volver a realizar el procedimiento de Alta Temprana</asp:Label> 
                </td>
            </tr>
            <tr>
