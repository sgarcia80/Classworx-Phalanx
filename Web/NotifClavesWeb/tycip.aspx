<%@ Page Language="C#" MasterPageFile="~/Principal.master" AutoEventWireup="true"
    CodeBehind="tycip.aspx.cs" Inherits="NotifClavesWeb.tycip" Title="Macro SA - Notificación de Claves"
            ...
            <td>
                <div style="overflow: auto; width: 750px; height: 500px; color: Black; overflow-x: hidden">
                        <p class="Cabecera" style='margin-left: 0cm'>
                            <span lang="ES-TRAD">Gerencia de Seguridad Informática</span></p>
                        <p class="MsoNormal">
                            <span lang="ES-TRAD">&nbsp;</span></p>
                        <p class="Cabecera2" style='margin-left: 0cm'>
                            <span lang="ES-TRAD">Anexo</span></p>
                        <p class="MsoNormal">
                            <span lang="ES">&nbsp;</span></p>
                        <p class="MsoNormal">
                            <span lang="ES">&nbsp;</span></p>
                        <table class="MsoNormalTable" border="0" cellspacing="0" cellpadding="0" width="586"
                            ...
                            <tr>
                                <td width="84" valign="top" style='width: 63.25pt; padding: 0cm 3.5pt 0cm 3.5pt'>
                                    <p class="TablaTitulo">
                                        <span lang="ES">Título:</span></p>
                                </td>
                                <td width="502" valign="top" style='width: 376.2pt; padding: 0cm 3.5pt 0cm 3.5pt'>
                                    <p class="TablaTitulo">
                                        <span lang="ES-MX">Reglamento sobre el Uso de los Recursos Informáticos de la Entidad</span></p>
                                </td>
                            </tr>
                            <tr>
                                <td width="84" valign="top" style='width: 63.25pt; padding: 0cm 3.5pt 0cm 3.5pt'>
                                    <p class="TablaTitulo">
                                        <span lang="ES">Versión:</span></p>
                                </td>
                                <td width="502" valign="top" style='width: 376.2pt; padding: 0cm 3.5pt 0cm 3.5pt'>
                                    <p class="TablaTitulo">
                                        <span lang="ES-MX">Diciembre 2014</span></p>
                                </td>
                            </tr>
                        </table>
                        <p class="MsoNormal">
                        ...
                        <p class="MsoNormal">
                            <span lang="ES">El presente documento alcanza a todo el personal del Banco Macro, incluyendo
                                proveedores que utilicen la red del Banco.</span></p>
                        <p class="MsoNormal">
                        ...
                        <p class="ListaconVietas">
                            ...
                            </span></span><span lang="ES">Seguridad Lógica</span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </span></span><span lang="ES">Hardware e Instalaciones</span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </span></span><span lang="ES">Internet</span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </span></span><span lang="ES">Correo</span></p>
                        ...
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                que se ejecuten en cualquier sistema bajo su cuenta de usuario.</span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                de seguridad existentes. Ver “<span style='color: black'>Administración de Incidentes
                                    de Seguridad de la Información”.</span></span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol; color: black'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </span></span><span lang="ES">Los usuarios deben informar <span style='color: black'>
                                a la Gerencia de Seguridad Informática,</span> en forma personal, telefónica o mediante
                        ...
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                class="ListaconVietasCar">ar probar una posible debilidad en la seg</span>uridad.</span></p>
                        <div style='border: none; border-bottom: solid #0193D0 1.0pt; padding: 0cm 0cm 1.0pt 0cm;
                            margin-left: 35.45pt; margin-right: 0cm'>
                            <h3 style='margin-left: 0cm; text-indent: 0cm'>
                        ...
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                de la entidad.</span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </span></span><span lang="ES">Los usuarios no deben efectuar cambios respecto al uso
                                y disposición del cableado correspondiente al equipamiento instalado.</span></p>
                        <h4 style='text-indent: 0cm'>
                        ...
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                al personal de la Gerencia de Tecnología.</span></p>
                        <h4 style='text-indent: 0cm'>
                        ...
                        <p class="ListaconVietas" style='margin-left: 53.3pt; text-indent: -17.85pt; page-break-after: avoid'>
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                destino del uso (ver Estándar Configuración de PC´s de Escritorio y Equipos Portátiles).</span></p>
                        <h4 style='text-indent: 0cm'>
                        ...
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                del equipamiento informático asignado para el cumplimiento de sus funciones.</span></p>
                        <p class="ListaconVietas">
                            <span style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                sucursal.</span></p>
                        <h4 style='text-indent: 0cm'>
                            Dispositivos<span lang="EN-US"> de</span><span lang="EN-US"> </span><span lang="ES">
                                almacenamiento</span><span lang="ES"> </span><span lang="EN-US">portátiles</span></h4>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                de datos o archivos de trabajo.</span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                con la autorización del Gerente de primera línea.</span></p>
                        <div style='border: none; border-bottom: solid #0193D0 1.0pt; padding: 0cm 0cm 1.0pt 0cm;
                            margin-left: 35.45pt; margin-right: 0cm'>
                            <h3 style='margin-left: 0cm; text-indent: 0cm'>
                        ...
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                por personal autorizado por la Gerencia de Tecnología.</span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </span></span><span lang="ES">Los usuarios no deben modificar la configuración del sistema
                                y/ o dispositivos de los puestos de trabajo.</span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                probará dicho programa y una vez homologado se podrá solicitar su instalación.</span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                a los estándares ya configurados.</span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                clasificación. Ver Norma de Usuario Final.</span></p>
                        <h4 style='text-indent: 0cm'>
                        ...
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                su buzón de correo. En función de ello deben aplicar depuraciones periódicas.</span></p>
                        <div style='border: none; border-bottom: solid #0193D0 1.0pt; padding: 0cm 0cm 1.0pt 0cm;
                            margin-left: 35.45pt; margin-right: 0cm'>
                            <h3 style='margin-left: 0cm; text-indent: 0cm'>
                        ...
                        <p class="ListaconVietas" style='margin-left: 106.8pt'>
                            <span lang="ES" style='font-family: Wingdings'>ü<span style='font: 7.0pt "Times New Roman"'>&nbsp;
                                ...
                                usuarios autorizados por la Gerencia de Recursos Humanos.</span></p>
                        <p class="ListaconVietas1" style='margin-left: 106.8pt; text-indent: -18.0pt'>
                            <span lang="ES" style='font-family: Wingdings'>ü<span style='font: 7.0pt "Times New Roman"'>&nbsp;
                                ...
                                lang="ES"> todo el personal del Banco.</span></p>
                        <p class="ListaconVietas1" style='margin-left: 106.8pt; text-indent: -18.0pt'>
                            <span lang="ES" style='font-family: Wingdings'>ü<span style='font: 7.0pt "Times New Roman"'>&nbsp;
                            </span></span><b><span lang="ES">Grupo 3 – Acceso a Internet Medio:</span></b><span
                                lang="ES"> personal del área de Sistemas.</span></p>
                        <p class="ListaconVietas1" style='margin-left: 106.8pt; text-indent: -18.0pt'>
                            <span lang="ES" style='font-family: Wingdings'>ü<span style='font: 7.0pt "Times New Roman"'>&nbsp;
                                ...
                                de las Gerencias de Recursos Humanos y de Relaciones Institucionales.</span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                es efectuada de manera automática y dinámica.</span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </span></span><span lang="ES">Los sitios conocidos por estar infectados con virus o
                                spyware se bloquean de manera automática, al igual que los sitios de contenido inapropiado.</span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </span></span><span lang="ES">Se limita el acceso a sitios que generan exceso del uso
                                del ancho de banda pudiendo afectar la operatoria de la Entidad.</span></p>
                        <h4 style='text-indent: 0cm'>
                        ...
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                no afecten la calidad o productividad de su trabajo.</span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                reservada de la Entidad.</span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                otras páginas de medios.</span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                antes de que se publiquen en la red.</span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                caso, pueden ser utilizadas con fines personales.</span></p>
                        <p class="ListaconVietas" style='margin-left: 0cm; text-indent: 0cm'>
                            <span lang="ES">La Entidad emplea controles técnicos para proporcionar recordatorios,
                                supervisar y hacer cumplir estas reglas.</span></p>
                        <p class="MsoNormal">
                        ...
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </span></span><span lang="ES">El correo puede ser monitoreado por el Banco.</span></p>
                        <h4 style='text-indent: 0cm'>
                        ...
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                que puedan provocar problemas en la información o puestos de trabajo de los destinatarios.</span></p>
                        <h4 style='text-indent: 0cm'>
                        ...
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                No deben tomar como válida o hacer uso de la información recibida de fuentes desconocidas.</span></p>
                        <p class="ListaconVietas">
                            <span lang="ES" style='font-family: Symbol'>·<span style='font: 7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <br />
                    <br />
                    <asp:CheckBox ID="cbDesbloqueo" runat="server" AutoPostBack="true" CssClass="LabelNormal"
                        OnCheckedChanged="cbDesbloqueo_CheckedChanged" Text="Recuerde que para la autogestión de Desbloqueo/Blanqueo de Usuario de Red, deberá utilizar la herramienta</br> Tivoli Identity Manager.
Para ello deberá primero acceder por unica vez a https://miacceso" />
                <br />
                <br />
            </td>
        </tr>
