<%@ Page Language="C#" MasterPageFile="~/Principal.master" AutoEventWireup="true" CodeBehind="CargaRespuestasUsr.aspx.cs" Inherits="NotifClavesWeb.CargaRespuestasUsr" Title="Macro SA - Edición de Claves" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <br />
    <div class="tituloSeccion">
        Cargar/Editar Preguntas de Seguridad</div>
    <br />
    <div style="text-align: center left">
        <table border="0" cellspacing="1" width="100%" cellpadding="1" style="background-color: White">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtQuestion1" runat="server" CssClass="labelCombo" Width="327px" MaxLength="250"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtQuestion2" runat="server" CssClass="labelCombo" Width="327px" MaxLength="250"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtQuestion3" runat="server" CssClass="labelCombo" Width="327px" MaxLength="250"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtQuestion4" runat="server" CssClass="labelCombo" Width="327px" MaxLength="250"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtQuestion5" runat="server" CssClass="labelCombo" Width="327px" MaxLength="250"></asp:TextBox>
                </td>
            </tr>
        </table>
    <br />
