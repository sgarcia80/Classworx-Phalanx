<%@ Page Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="ValidaRespuestas.aspx.cs" Inherits="NotifClavesWeb.ValidaRespuestas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="text-align: left">
        ...
        <table id="Table3" width="100%" cellspacing="1" cellpadding="1" border="0">
            <tr style="height: 5px">
                <td style="width: 98px; height: auto; background-color: #b0e0e6;"></td>
                <td style="background-color: #b0e0e6; height: auto; padding-left: 1"></td>
            </tr>
            <tr style="background-color: #f0f8ff">
                <td style="width: 98px; height: 19px;"></td>
            ...
            <tr id="trBotGuardar" runat="server">
                ...
                <td align="left" valign="middle">&nbsp;&nbsp;
                    <asp:Button ID="btnVolver" runat="server" CssClass="btn" Text="Volver"
                        ToolTip="Volver" CausesValidation="False" PostBackUrl="~/NotificacionClave.aspx"></asp:Button>
                </td>
            </tr>
        </table>
    </div>
