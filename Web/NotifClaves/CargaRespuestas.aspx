<%@ Page Language="C#" MasterPageFile="~/Principal.master" AutoEventWireup="true" CodeFile="CargaRespuestas.aspx.cs" Inherits="CargaRespuestas" Title="Macro SA - Notificación de Claves" %>
        ...
        <table id="Table3" width="100%" cellspacing="1" cellpadding="1" border="0">
            ...
            <tr style="background-color: #f0f8ff">
                ...
                <td style="text-align: center left; width: auto; height: 19px;">
                    <asp:Label ID="lblTitulo" runat="server" CssClass="tdTituloSub">Carga de Respuestas de Seguridad</asp:Label>
                </td>
            </tr>
