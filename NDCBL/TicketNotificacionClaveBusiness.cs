...
namespace NDCBL
{
    ...
    public class TicketNotificacionClaveBusiness
    {
        ...
        public TicketNotificacionClaveEntityCollection GetTickesByUser(AplicacionNotificacionClaveEntity aplicacion, string dominio, string usuario, string app_user, string tipodocumento, string documento, bool sinlegajo, DateTime fechadesde, bool? notificado)
        {
            TicketNotificacionClaveFactory factory = new TicketNotificacionClaveFactory();
        ...
        {
            TicketNotificacionClaveEntity ticket = Factory.GetById(id);
        ...
        public bool ReGenerateToken(TicketNotificacionClaveEntity ticket, out string MsgOut)
        {
            ...
            try
            {
                ...
                if (ticket.MailId != null)
                {
                    ...
                    MABL.UpdateMailRegeneraToken(ticket.MailId.Value, ticket.Token, solicitante, ticket.NumeroSolicitud.GetValueOrDefault(), ticket.Fecha, destino);
                }
                else
                {
